...
def check_publisher_price_offline(
    current_slot, publisher_slot, publisher_status, product_attrs, expected_str
):
    network = "mainnet"
    symbol = "ZZZT"
    ...
    price = Price(
        current_slot, product_attrs=product_attrs, publishers={publisher_key: "pubname"}
    )
